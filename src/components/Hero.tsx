  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-6 text-center">
        <div className="hero-enter hero-enter-1 inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-500/10 border border-blue-500/15 mb-8">
        ...
        <h1 className="hero-enter hero-enter-2 text-5xl sm:text-6xl lg:text-7xl font-bold text-text-primary leading-[1.1] tracking-tight mb-6">
          {siteConfig.name}
        </h1>

        <p className="hero-enter hero-enter-3 text-lg sm:text-xl text-text-secondary max-w-2xl mx-auto mb-4 font-medium">
          {siteConfig.title}
        </p>

        <p className="hero-enter hero-enter-4 text-base text-text-secondary/80 max-w-xl mx-auto mb-10 leading-relaxed">
          {siteConfig.tagline}
        </p>

        <div className="hero-enter hero-enter-5 flex flex-wrap items-center justify-center gap-4 mb-10">
          <a
            href="#projects"
